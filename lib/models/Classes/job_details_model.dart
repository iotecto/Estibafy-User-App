...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    containerId: json["container_id"] == null ? null : json["container_id"]!,
    ...
    jobHelpers: json["job_helpers"] == null ? null : List<JobHelper>.from(json["job_helpers"].map((x) => JobHelper.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "job_helpers": jobHelpers == null ? null : List<dynamic>.from(jobHelpers!.map((x) => x.toJson())),
  };
}
...
class Checkout {
  ...
  factory Checkout.fromJson(Map<String, dynamic> json) => Checkout(
    ...
    userId: json["user_id"] == null ? null : json["user_id"]!,
    totalHelpers: json["total_helpers"] == null ? null : json["total_helpers"]!,
...
class JobHelper {
  ...
  factory JobHelper.fromJson(Map<String, dynamic> json) => JobHelper(
    ...
    status: json["status"] == null ? null : json["status"]!,
    jobCommentStatus: json["job_comment_status"] == null ? null : json["job_comment_status"]!,
    approvedBy: json["approved_by"] == null ? null : json["approved_by"]!,
    createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
    updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
    helperProfile: json["helper_profile"] == null ? null : HelperrProfile.fromJson(json["helper_profile"]),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "status": status == null ? null : status!,
    "job_comment_status": jobCommentStatus == null ? null : jobCommentStatus!,
    "approved_by": approvedBy == null ? null : approvedBy!,
    "created_at": createdAt == null ? null : createdAt!.toIso8601String(),
    "updated_at": updatedAt == null ? null : updatedAt!.toIso8601String(),
    "helper_profile": helperProfile == null ? null : helperProfile!.toJson(),
  };
}
